    ...
    try {
        ...
        const data = await page.evaluate(async () => {
            ...
            if (toggler) {
                ...
                let colors_data = Array.from(document.querySelectorAll('div[class="c-form-field c-form-field--radio SelectStyle col"'));

                colors_data = await colors_data.map((element) => {
...
scrapeSite('https://www.footlocker.com/product/nike-air-force-1-low-mens/24300657.html');